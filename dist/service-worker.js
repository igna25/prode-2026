...
function F(a) {
  ...
  return (s.searchParams.set(j, e), { cacheKey: s.href, url: n.href });
}
class H {
  constructor() {
    ((this.updatedURLs = []),
...
class $ {
  ...
  async cachePut(e, t) {
    ...
    if (!t) throw new l("cache-put-with-no-response", { url: D(n.url) });
    ...
    const { cacheName: c, matchOptions: i } = this._strategy,
      ...
      g = h ? await O(o, n.clone(), ["__WB_REVISION__"], i) : null;
    try {
      await o.put(n, h ? r.clone() : r);
    } catch (u) {
      if (u instanceof Error)
        throw (u.name === "QuotaExceededError" && (await W()), u);
    }
...
let y;
const J = () => (
  y || ((y = new z()), y.addFetchListener(), y.addCacheListener()),
  y
);
function X(a, e, t) {
  let s;
...
ne();
ce([
  { revision: "ac977f467b4f7d867c59b079850afef7", url: "index.html" },
  { revision: null, url: "assets/workbox-window.prod.es5-BBnX5xw4.js" },
  { revision: null, url: "assets/index-B3fztR-1.css" },
  { revision: null, url: "assets/index--K8ROIjG.js" },
  { revision: "df8ff1caf7fab214128cf2d074991a69", url: "favicon.svg" },
  { revision: "219169c9e1ff275ba6845731282b15e1", url: "icon-192x192.png" },
  { revision: "d172fda7a38559dd20b2acf86e73e0a8", url: "icon-512x512.png" },
  { revision: "bb9a95fc62604b43902b6ca661477ca0", url: "icons/icon.svg" },
  { revision: "65c8ca7231feda81655981fe4e44d8a6", url: "manifest.webmanifest" },
]);
self.addEventListener("push", (a) => {
  var n, r;
  const e =
      ((r = (n = a.data) == null ? void 0 : n.json) == null
        ? void 0
        : r.call(n)) ?? {},
    t = e.title ?? "Prode Mundialista 2026",
    s = e.body ?? "Tenés una predicción pendiente.";
  a.waitUntil(
...
self.addEventListener("notificationclick", (a) => {
  ...
  a.waitUntil(clients.openWindow(e));
});
